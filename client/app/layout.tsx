      ...
      <head>
        ...
        {pixelSettings.facebookPixel && (
          <script dangerouslySetInnerHTML={{
            ...
            fbq('init', '${pixelSettings.facebookPixel}');
            fbq('track', 'PageView');`
          }} />
        )}
        {/* TikTok Pixel */}
        {pixelSettings.tiktokPixel && (
          <script dangerouslySetInnerHTML={{
            ...
            ttq.load('${pixelSettings.tiktokPixel}');
            ttq.page();
          }(window, document, 'ttq');`
          }} />
        )}
        {/* Google Tag Manager */}
        {pixelSettings.googleTagManager && (
          <script dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window,document,'script','dataLayer','${pixelSettings.googleTagManager}');
            `
          }} />
        )}
      </head>
